...
DialogInformacionInterfaz_class , DialogInformacionInterfazBase_class = uic.loadUiType( 'gui/administrador/uis/DialogInformacion.ui' )
...
DialogNuevaCausaInterfaz_class , DialogNuevaCausaInterfazBase_class = uic.loadUiType( 'gui/administrador/uis/DialogNuevaCausa.ui' )
